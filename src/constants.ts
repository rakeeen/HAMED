...
export const PROJECTS: Project[] = [
  {
    ...
    description: { 
        ...
        ar: 'مسكت الـ UI/UX بتاع منصة سعودية للعائلات من الألف للياء. صممت ميزة "إدارة العيلة" اللي بتخلي أي حد يحجز للأفراد اللي ملهومش في التكنولوجيا، وده سهل الدنيا جداً لكبار السن.',
        it: 'Ho guidato UI/UX dall\'inizio alla fine per una piattaforma saudita focalizzata sulla famiglia. Ho progettato la funzione "Gestione Famiglia" che consente le prenotazioni ai membri meno esperti, estendendo l\'accessibilità alle generazioni più anziane.'
    },
    tags: [
  ...
  },
  {
    ...
    description: {
        ...
        ar: 'صممت نظام خاص لإدارة الإيرادات بيستخدمه أكتر من 1500 مستخدم، وحولت فيه البيانات المالية المعقدة لرسومات واضحة وسهلة تتاخد بناء عليها قرارات.',
        it: 'Ho progettato un sistema privato di gestione ricavi utilizzato da 1.500+ utenti, trasformando dati finanziari complessi in visualizzazioni intuitive.'
    },
    tags: [
  ...
  },
  {
    ...
    description: {
        ...
        ar: 'عملت تجربة المستخدم كاملة لتطبيق خدمات منزلة بيوصل الفنيين بالبيوت عن طريق الـ GPS، وكان تركيزي كله إن التطبيق يكون موثوق وسهل الاستخدام.',
        it: 'Costruito l\'esperienza utente completa per un\'app di servizi basata sulla geolocalizzazione che collega i tecnici alle case, focalizzandomi su affidabilità e facilità d\'uso.'
    },
    tags: [
  ...
  },
  {
    ...
    description: {
        ...
        ar: 'أسست وبنيت نظام داخلي كامل ورحلة عميل لشركة ناشئة بتقدم حلول لتحديات الحياة اليومية. كنت بدير شغل الفريق وماسك استراتيجية "التصميم للبيزنس".',
        it: 'Ho fondato e costruito un sistema interno end-to-end e il customer journey per una startup che risolve sfide quotidiane. Ho gestito i flussi di lavoro del team e guidato la strategia di "Design for Business".'
    },
    tags: [
...
export const TIMELINE: TimelineItem[] = [
  {
    ...
    description: { 
        ...
        ar: 'مسكت مرحلة الـ UI/UX لتطبيق "الحياة" من الصفر بالشراكة مع فرق تانية. صممت ميزة "إدارة العيلة" اللي سهلت الدنيا لكبار السن، وبسطت طرق التنقل في التطبيق عشان المستخدمين في السعودية يلاقوا تجربة مريحة.',
        it: 'Ho guidato la fase UI/UX dell\'app "Alhayat" da zero, collaborando con team multifunzionali. Ho semplificato i complessi flussi di navigazione, garantendo un\'esperienza ottimale per un pubblico sempre più vasto in Arabia Saudita.'
    },
    tags: [
        { en: 'Saudi Arabia', ar: 'السعودية', it: 'Arabia Saudita' },
  ...
  },
  {
    ...
    description: {
        ...
        ar: 'خلصت مشاريع تقيلة في مصر والسعودية وكندا. صممت نظام لإدارة الأرباح لـ 1500 مستخدم، وعملت واجهة تطبيق "تمام" للخدمات. بدأت أدخل الـ AI Prompt Engineering في شغلي عشان أعمل بروتوتايبس بسرعة البرق وأوفر وقت كتير.',
        it: 'Ho fornito design di grande impatto in Egitto, Arabia Saudita e Canada. Ho progettato un sistema di gestione ricavi per 1.500+ utenti. Ho integrato l\'Ingegneria dei Prompt IA nei cicli di design per una prototipazione rapida.'
    },
    tags: [
...
export const COMPETENCIES: Competency[] = [
  {
    ...
    description: { 
        ...
        ar: 'أبحاث المستخدمين، Wireframing، بنية المعلومات، اختبار سهولة الاستخدام، حل المشكلات، الـ User Flows، وتصميم المواقع المتجاوبة.',
        it: 'Ricerca degli utenti, Wireframing, Architettura dell\'informazione, Test di usabilità, Risoluzione di problemi, User flows.'
    },
  ...
  },
  {
    ...
    description: {
        ...
        ar: 'التصميم المينيماليست، نظرية الألوان، التيبوجرافي، سرد القصة بالمرئيات، أنظمة التصميم، والهوية البصرية.',
        it: 'Design Minimalista, Teoria dei colori, Tipografia, Visual Storytelling, Design Systems.'
    },
    icon: 'palette'
  },
  {
    ...
    description: {
        ...
        ar: 'تصميم البروتوتايب بمساعدة الـ AI، الـ Prompt Engineering، أتمتة التصميم، وتسريع التسليم 10 أضعاف.',
        it: 'Prototipazione assistita dall\'IA, Ingegneria dei prompt, Automazione del design, Accelerazione delle consegne.'
    },
    icon: 'auto_awesome'
  },
  {
    ...
    description: {
        ...
        ar: 'فيجما (مستخدم متمكن)، أدوات أدوبي (فوتوشوب، إليستريتور، بريميير، أفتر افكتس)، زيبلاين، وفريمر.',
        it: 'Figma (Power User), Adobe Creative Suite, VS Code, Framer (Principiante).'
    },
    icon: 'construction'
  },
  {
    ...
    description: {
        ...
        ar: 'التواصل، الشغل في فريق، حل المشاكل، إدارة الوقت، والتفكير النقدي.',
        it: 'Comunicazione, Collaborazione, Risoluzione dei problemi, Gestione del tempo, Pensiero Critico.'
    },
    icon: 'psychology'
  },
  {
    ...
    description: {
        ...
        ar: 'العربية (لغتي الأم)، الإنجليزية (جيد جداً). شهادة جوجل في أساسيات الـ UX ديزاين.',
        it: 'Arabo (Madrelingua), Inglese (Buono). Google Foundations of UX Design (Certificato Professionale).'
    },
    icon: 'language'
  }
];
